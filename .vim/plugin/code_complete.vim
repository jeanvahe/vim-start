...
let g:template['c']['ife'] = "if (".g:rs."...".g:re.")\<cr>{\<cr>".g:rs."...".g:re."\<cr>} else\<cr>{\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['printf'] = "printf(\"".g:rs."...".g:re."\", ".g:rs."...".g:re.");"
let g:template['c']['class'] = "class ".g:rs."...".g:re."\<cr>{\<cr>\<bs>public:\<cr>".g:rs."...".g:re."\<cr>};" 
let g:template['c']['us'] = "using namespace " 
...
" java templates
let g:template['java'] = {}
let g:template['java']['syso'] = "System.out.println(".g:rs."...".g:re.");" 
let g:template['java']['class'] = "public class ".g:rs."...".g:re."\<cr>{\<cr>".g:rs."...".g:re."\<cr>}" 
